      ...
      <div className="block space-y-1.5">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded-md p-1.5 text-board-muted transition hover:bg-white/5 hover:text-white"
